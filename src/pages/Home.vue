<template>
  ...
  <main class="main">
    <section class="home">
      <div class="container">
        <div class="home__switch-wrapper">
          <div class="home__switch">
            <div class="home__switch_off">וקפוהש תוסילופ</div>
            <div class="home__switch_on active">תונורחא תועצה</div>
          </div>
          <IconAvatar />
        </div>
        <div class="home__divider"></div>
        <div class="home__search">
          <BaseButton :medium="true" :icon="true" :mode="'green'"
